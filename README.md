This repo is **out of date and is archived**. Check out an [updated tutorial on using FusionAuth with Android here](https://fusionauth.io/docs/quickstarts/quickstart-android-java-native).
